...
//     });
//
//     // Only add serverRegion when specified
//     if let Some(r) = region {
//         variables["serverRegion"] = serde_json::Value::String(r.to_string());
//     }
//
...
//         .context("No rankings found in response")?;
//
//     tracing::info!("Found {} rankings, fetching talent strings (ignore private logs)...", rankings.len());
//
...
//         // skip private logs.
//         if name == "Anonymous" {
//             tracing::debug!("Skipping Private Log");
//             continue;
//         }
//
...
//         };
//
//         tracing::info!("Rank {}: {} - {} chars", rank_number, name, talent_string.len());
//
...
//
//     if results.is_empty() {
//         anyhow::bail!("No public logs found for this spec/encounter (likley not an error on WCL side...)")
//     }
//
//     Ok(results)
// }
